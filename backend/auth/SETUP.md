...
This folder is a self-contained, reusable authentication system built with FastAPI.
Drop it into any project and follow this guide to get it running.
...
```
auth/
├── models.py          →  User, RefreshToken, OAuthAccount tables
